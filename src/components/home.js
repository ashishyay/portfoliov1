...
const Home = ({ id }) => {
    ...
    const two = <h3>Ashish Upadhyay!</h3>;
    const three = <h5>I am a DevOps Engineer and </h5>
    const four = <h5><TextLoop interval={3000}>
        <span>a Tech Enthusiast. </span>
        <span>a Cloud Native Developer. </span>
        <span>a MS Certified Professional. </span>
    </TextLoop></h5>
    ...
    return (
        <StyledContainer id={id} fluid="lg">
            <Row xs={1} md={2}>
                <Col>
                    <LazyLoad>
                        <CustomImage src={profilePic} alt="Ashish Upadhyay Profile Picture"/>
                    </LazyLoad>
                </Col>
                <StyledIntroCol>
